...
const Select: React.ComponentType<SelectPrimitive.SelectProps> =
  SelectPrimitive.Root;

const SelectGroup: React.ComponentType<SelectPrimitive.SelectGroupProps> =
  SelectPrimitive.Group;

const SelectValue: React.ComponentType<SelectPrimitive.SelectValueProps> =
...
const SelectContent: React.ComponentType<SelectPrimitive.SelectContentProps> =
  React.forwardRef<
...
const SelectLabel: React.ComponentType<SelectPrimitive.SelectLabelProps> =
  React.forwardRef<
  ...
  >(({ className, ...props }, ref) => (
    <SelectPrimitive.Label
      ref={ref}
      className={cn(
        "py-1.5 pl-8 pr-2 text-sm font-semibold text-slate-900 dark:text-slate-200 ",
        className
      )}
      {...props}
    />
...
const SelectItem: React.ComponentType<SelectPrimitive.SelectItemProps> =
  React.forwardRef<
...
const SelectSeparator: React.ComponentType<SelectPrimitive.SelectSeparatorProps> =
  React.forwardRef<
